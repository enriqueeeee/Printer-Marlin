...
#define STRING_CONFIG_H_AUTHOR "(Erik, default config)" // Who made the changes.
...
//old
 ...
 // #define  DEFAULT_bedKd 730.72
  ...
  #define  DEFAULT_bedKp 114.71
  #define  DEFAULT_bedKi 5.56
  #define  DEFAULT_bedKd 592
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 1.98   // Z offset: -below +above  [the nozzle] was 1,81
